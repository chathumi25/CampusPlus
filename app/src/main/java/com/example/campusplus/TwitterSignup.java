...
public class TwitterSignup extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.twittet_signup_main);
        ...
        loginText.setOnClickListener(v -> {
            startActivity(new Intent(TwitterSignup.this, LoginActivity.class));
            finish();
        });
                                        ...
                                        user.sendEmailVerification()
                                                .addOnCompleteListener(verifyTask -> {
                                                    if (verifyTask.isSuccessful()) {
                                                        ...
                                                        clearFields();
                                                        startActivity(new Intent(TwitterSignup.this, NewsMainActivity.class));
                                                        finish();
                                                    } else {
