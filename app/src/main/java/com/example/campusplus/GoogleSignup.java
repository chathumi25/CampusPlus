...
public class GoogleSignup extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.google_signup_main);
        ...
        loginText.setOnClickListener(v -> {
            startActivity(new Intent(GoogleSignup.this, LoginActivity.class));
            finish();
        });
                                        ...
                                        user.sendEmailVerification()
                                                .addOnCompleteListener(verifyTask -> {
                                                    if (verifyTask.isSuccessful()) {
                                                        ...
                                                        clearFields();
                                                        startActivity(new Intent(GoogleSignup.this, NewsMainActivity.class));
                                                        finish();
                                                    } else {
