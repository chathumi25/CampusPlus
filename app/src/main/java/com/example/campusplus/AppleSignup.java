...
public class AppleSignup extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.apple_signup_main);
        ...
        loginText.setOnClickListener(v -> {
            startActivity(new Intent(AppleSignup.this, LoginActivity.class));
            finish();
        });
                                        ...
                                        user.sendEmailVerification()
                                                .addOnCompleteListener(verifyTask -> {
                                                    if (verifyTask.isSuccessful()) {
                                                        ...
                                                        clearFields();
                                                        startActivity(new Intent(AppleSignup.this, NewsMainActivity.class));
                                                        finish();
                                                    } else {
